 ...
 */
final class Version20220713155437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP image_file');
        ...
        $this->addSql('ALTER TABLE taille_boisson DROP boisson_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE produit ADD image_file VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE taille_boisson ADD boisson_id INT DEFAULT NULL');
