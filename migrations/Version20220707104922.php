 ...
 */
final class Version20220707104922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livraison DROP livreur_id, CHANGE etat etat SMALLINT DEFAULT 1');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE livraison ADD livreur_id INT NOT NULL, CHANGE etat etat SMALLINT DEFAULT NULL');
